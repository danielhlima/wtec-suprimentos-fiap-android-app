...
public class CustomersToClassifyFragment extends Fragment implements DataOut.Callback<List<Customer>>, ClickRecyclerViewHelper {
    ...
    public CustomersToClassifyFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView)view.findViewById(R.id.rcv_customers_to_classify);
